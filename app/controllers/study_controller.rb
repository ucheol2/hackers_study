class StudyController < ApplicationController
  ...
  def fine_proc
    ...
    respond_to do |format|
      format.json { render json: {id: studee.id, deposit: studee.deposit, his: new_his, fine: new_his.get_fine, date: new_his.created_at.in_time_zone("Seoul").strftime("%Y-%m-%d %a")}}
    end
  end
